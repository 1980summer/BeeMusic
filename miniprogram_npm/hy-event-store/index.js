...
__DEFINE__(1652938044777, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1652938044778,"./event-store":1652938044779}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652938044778, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1652938044779, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1652938044778,"./utils":1652938044780}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652938044780, function(require, module, exports) {
...
return __REQUIRE__(1652938044777);
})()
